...
[TestClass]
public class DatabaseConnectionWithUseManagedNetworkingTrueFixture
{
    [TestInitialize]
    ...
    [TestMethod]
    // [Timeout(10000)]
    public void ConnectToDatabase_ConnectionString_Localhost_NamedInstance()
    {
        var instanceName = "MSSQLLocalDB";
        ...
        var connstr = @"Data Source=localhost\MSSQLLocalDB;Initial Catalog=master;Integrated Security=True;Connect Timeout=15;";
